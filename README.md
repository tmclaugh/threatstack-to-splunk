# threatstack-to-splunk [![Build Status](https://travis-ci.org/threatstack/threatstack-to-splunk.svg?branch=master)](https://travis-ci.org/threatstack/threatstack-to-splunk)
...
Stack](https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=threatstack-to-splunk&templateURL=https://s3.amazonaws.com/ts-demo-lambda-deploys/threatstack-to-splunk.json)
